...
var hebMonth = new makeArray(
	'Нисан', 'Ияр', 'Сиван', 'Тамуз', 'Ав', 'Элуль',
...
var civMonthShort = new makeArray(
	'Янв', 'Фев', 'Март', 'Апр', 'Май', 'Июнь',
	'Июль', 'Авг', 'Сен', 'Окт', 'Ноя', 'Дек');

var weekDay = new makeArray(
	'Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Шабес');
var weekDayShort = new makeArray(
	'В', 'П', 'В', 'С', 'Ч', 'П', 'Ш');

var weekDayFull = new makeArray(
	'Воскресенье', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Шабес');
