...
<table cellpadding='0' cellspacing='0' width='100%'>
  <tr>
    <td class='event_header'><?php echo SELanguage::_get(3000252); ?></td>
  </tr>
  <tr>
    <td class='event_box'>
        ...
        <tr>
          <td class='editprofile_photoleft'>
            <?php echo SELanguage::_get(770); ?>
            <br />
            <table cellpadding='0' cellspacing='0' width='202'>
              <tr>
                <td class='editprofile_photo'><img src='<?php echo $this->_tpl_vars['event']->event_photo("./images/nophoto.gif"); ?>
' border='0'></td>
              </tr>
            </table>
            <?php if ($this->_tpl_vars['event']->event_photo()): ?>
              <br />
              [ <a href='user_event_edit.php?event_id=<?php echo $this->_tpl_vars['event']->event_info['event_id']; ?>
&task=remove'><?php echo SELanguage::_get(771); ?></a> ]
            <?php endif; ?>
          </td>
          <td class='editprofile_photoright'>
            <form action='user_event_edit.php' method='POST' enctype='multipart/form-data'>
            <?php echo SELanguage::_get(772); ?>
            <br />
            <input type='file' class='text' name='photo' size='30' />
            <input type='submit' class='button' value='<?php echo SELanguage::_get(772); ?>' />
            <input type='hidden' name='task' value='upload' />
            <input type='hidden' name='MAX_FILE_SIZE' value='5000000' />
            <input type='hidden' name='event_id' value='<?php echo $this->_tpl_vars['event']->event_info['event_id']; ?>
' />
            </form>
            <br />
            <?php echo sprintf(SELanguage::_get(3000140), '5 MB', $this->_tpl_vars['event']->eventowner_level_info['level_event_photo_exts']); ?>
          </td>
        </tr>
      </table>
    </td>
...
<table cellpadding='0' cellspacing='0' width='100%'>
  <tr>
    <td class='event_header'><?php echo SELanguage::_get(3000137); ?></td>
  </tr>
  <tr>
    <td class='event_box'>
