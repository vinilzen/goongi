 ...
 * ==============================================================================
 * 
 * @version $Id: class_blog_trackback.php 1 2009-01-10 12:24:57Z john $
...
class Trackback
{
  ...
  function Trackback($blog_name, $author, $encoding = "UTF-8")
  {
    ...
    $this->bname    = ( !empty($_POST['blog_name']) ? $_POST['blog_name'] : ( !empty($_GET['blog_name'])  ? $_GET['blog_name']  : NULL ) );
