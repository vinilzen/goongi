    ...
    <li >
		...
		<a href="{$url->url_create('profile', $pms[pm_loop].pm_user->user_info.user_username)}">
                {if $pms[pm_loop].pm_user->user_info.profilevalue_5 == 2}
                        <img src="{$pms[pm_loop].pm_user->user_photo('./images/avatars_17.gif', TRUE)}"  alt="{lang_sprintf id=786 1=$pms[pm_loop].pm_user->user_displayname_short}" >
                {else}
                        <img src="{$pms[pm_loop].pm_user->user_photo('./images/avatars_15.gif', TRUE)}"  alt="{lang_sprintf id=786 1=$pms[pm_loop].pm_user->user_displayname_short}" >
                {/if}
