...
{* $Id: user_vizitki_album_upload.tpl 5 2009-01-11 06:01:16Z john $ *}
...
<div class="sevizitkiAlbum">
  ...
  <div class="sevizitkiAlbumUploaderDiv">
    {include file='user_upload.tpl' action='user_vizitki_album_upload.php' session_id=$session_id upload_token=$upload_token show_uploader=$show_uploader inputs=$inputs file_result=$file_result}
  </div>
