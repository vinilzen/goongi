...
<table cellpadding="3" cellspacing="0" border="0" align="center" width="400">
  ...
  <tr>
    <td align="left"><div style="margin-top: 10px; margin-bottom: 0px;">
        ...
        <div style="float: left; text-align: center; width: 90px;"><a href='{$url->url_create('profile', $gift_author->user_info.user_username)}'><img src='{$gift_author->user_photo('./images/nophoto.gif')}' class='photo' width='{$misc->photo_size($gift_author->user_photo('./images/nophoto.gif'),'75','75','w')}' border='0'></a></div>
