...
{* $Id: user_history_album_browse.tpl 20 2009-01-15 04:04:40Z john $ *}
...
<link rel="stylesheet" href="./templates/styles_history_album.css" title="stylesheet" type="text/css" />
...
<script type="text/javascript">
  ...
  {
    var currentElement = $('sehistoryAlbum_album_' + album_id);
    var currentMode = ( currentElement.style.display=="none" ? 'block' : 'none' );
    
    $$('.sehistoryAlbum_album').each(function(eachElement)
    {
  ...
  {
    var currentElement = $('sehistoryAlbum_albumMedia_image_' + media_id);
    var currentMode = ( currentElement.style.display=="none" ? 'block' : 'none' );
    
    $$('.sehistoryAlbum_albumMedia_image').each(function(eachElement)
    {
      if( eachElement.id==currentElement.id )
        eachElement.style.display = currentMode;
      else
...
<div class="sehistoryAlbum">
  ...
  {if empty($album_id)}
    ...
    <div class="sehistoryAlbumHeadline"><a href="user_history_album_browse.php">My Albums</a></div>
    <br />
    ...
    {section name=album_loop loop=$albums}
      ...
      <tr>
        <td>
          <a href="user_history_album_browse.php?album_id={$albums[album_loop].album_id}">
        ...
        <td style="vertical-align: top; padding-top: 2px; padding-left: 5px;">
          <a href="user_history_album_browse.php?album_id={$albums[album_loop].album_id}" valign="top" style="padding-top: 2px;">
            {$album_title}
          </a>
        </td>
      </tr>
  ...
  {elseif !empty($album_id) && $media_total>0}
    ...
    <div class="sehistoryAlbumHeadline"><a href="user_history_album_browse.php">My Albums</a> &gt;&gt;&gt; {$album_info.album_title}</div>
    <br />
