...
{* $Id: user_history_album_upload.tpl 5 2009-01-11 06:01:16Z john $ *}
...
<div class="sehistoryAlbum">
  ...
  <div class="sehistoryAlbumUploaderDiv">
    {include file='user_upload.tpl' action='user_history_album_upload.php' session_id=$session_id upload_token=$upload_token show_uploader=$show_uploader inputs=$inputs file_result=$file_result}
  </div>
